...
// import { Context } from 'koa'; // Removed for Next.js
import {
...
// Deleted model imports removed
// import Router from 'koa-router'; // Removed for Next.js
...
export class Chat {
  ...
  public async webshow(ctx: any) {
    ctx.body = 'not implement';
  }

  public async speech(ctx: any, req: SpeechRequest) {
    throw new ComError('not implement', ComError.Status.InternalServerError);
  }

  public async ImagesEdits(ctx: any, req: ImageEditRequest) {
    throw new ComError('not implement', ComError.Status.InternalServerError);
  }

  public async generations(ctx: any, req: ImageGenerationRequest) {
    throw new ComError('not implement', ComError.Status.InternalServerError);
  }

  public async embeddings(ctx: any, req: TextEmbeddingRequest) {
    throw new ComError('not implement', ComError.Status.InternalServerError);
  }

  public async transcriptions(ctx: any, req: TranscriptionRequest) {
    throw new ComError('not implement', ComError.Status.InternalServerError);
  }

  public async createVideoTask(ctx: any, req: CreateVideoTaskRequest) {
    throw new ComError('not implement', ComError.Status.InternalServerError);
  }

  public async queryVideoTask(ctx: any, req: QueryVideoTaskRequest) {
    throw new ComError('not implement', ComError.Status.InternalServerError);
  }

  public async createSong(ctx: any, req: any) {
    throw new ComError('not implement', ComError.Status.InternalServerError);
  }
  ...
  public dynamicRouter(router: any): boolean {
    return false;
  }
}
