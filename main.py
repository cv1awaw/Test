...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if chat.type not in ['group', 'supergroup']:
        logger.debug("Message is not from a group or supergroup. Ignoring.")
...
# Optional: Add a /test_arabic command
async def test_arabic(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """Test the Arabic detection functionality."""
...
def main():
    ...
    application.add_handler(CommandHandler("test_arabic", test_arabic))  # Added /test_arabic command
