...
# (Include all other command handlers here as per your original main.py)
...
async def be_sad_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        application = context.application  # Get the application instance
...
async def be_happy_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        application = context.application  # Get the application instance
        application.remove_handler(delete_handler)
