        ...
        with sqlite3.connect(DATABASE) as conn:
            ...
            for g_id, g_name in groups_data:
                ...
                try:
                    ...
                    c.execute('''
                        SELECT DISTINCT w.user_id, u.first_name, u.last_name, u.username
...
async def info_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        elif is_global_tara(user_id) or is_normal_tara(user_id):
            # For Global and Normal TARAs: Omit TARA info
